...
#include "llvm/Frontend/OmpSs/OSS.inc"
  ...
  StmtResult RebuildOSSExecutableDirective(ArrayRef<OSSClause *> Clauses,
    ...
    getSema().OmpSs().ActOnOmpSsAfterClauseGathering(RebuiltClauses);
    return getSema().OmpSs().ActOnOmpSsExecutableDirective(RebuiltClauses,
  ...
  OSSClause *RebuildOSSIfClause(Expr *Condition, SourceLocation StartLoc,
                                SourceLocation LParenLoc,
                                SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsIfClause(Condition, StartLoc, LParenLoc,
                                        EndLoc);
  }
  ...
  OSSClause *RebuildOSSFinalClause(Expr *Condition, SourceLocation StartLoc,
                                   SourceLocation LParenLoc,
                                   SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsFinalClause(Condition, StartLoc, LParenLoc,
                                           EndLoc);
  }
  ...
  OSSClause *RebuildOSSCostClause(Expr *Condition, SourceLocation StartLoc,
                                  SourceLocation LParenLoc,
                                  SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsCostClause(Condition, StartLoc, LParenLoc,
                                          EndLoc);
  }
  ...
  OSSClause *RebuildOSSPriorityClause(Expr *Condition, SourceLocation StartLoc,
                                  SourceLocation LParenLoc,
                                  SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsPriorityClause(Condition, StartLoc, LParenLoc,
                                          EndLoc);
  }
  ...
  OSSClause *RebuildOSSShmemClause(Expr *Condition, SourceLocation StartLoc,
                                   SourceLocation LParenLoc,
                                   SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsShmemClause(Condition, StartLoc, LParenLoc,
                                           EndLoc);
  }
  ...
  OSSClause *RebuildOSSLabelClause(
    ...
    return getSema().OmpSs().ActOnOmpSsLabelClause(
  ...
  OSSClause *RebuildOSSOnreadyClause(
      ...
      SourceLocation LParenLoc, SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsOnreadyClause(
  ...
  OSSClause *RebuildOSSChunksizeClause(
      ...
      SourceLocation LParenLoc, SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsChunksizeClause(
  ...
  OSSClause *RebuildOSSGrainsizeClause(
      Expr *Condition, SourceLocation StartLoc,
      SourceLocation LParenLoc, SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsGrainsizeClause(
      Condition, StartLoc, LParenLoc, EndLoc);
  }
  ...
  OSSClause *RebuildOSSUnrollClause(
      Expr *Condition, SourceLocation StartLoc,
      SourceLocation LParenLoc, SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsUnrollClause(
      Condition, StartLoc, LParenLoc, EndLoc);
  }
  ...
  OSSClause *RebuildOSSCollapseClause(Expr *Num, SourceLocation StartLoc,
                                      SourceLocation LParenLoc,
                                      SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsCollapseClause(Num, StartLoc, LParenLoc,
                                              EndLoc);
  }
  ...
  RebuildOSSDependClause(ArrayRef<OmpSsDependClauseKind> DepKinds, SourceLocation DepLoc,
    ...
    return getSema().OmpSs().ActOnOmpSsDependClause(DepKinds, DepLoc, ColonLoc, VarList,
  ...
  RebuildOSSReductionClause(OmpSsClauseKind Kind, ArrayRef<Expr *> VarList,
    ...
    return getSema().OmpSs().ActOnOmpSsReductionClause(Kind,
  ...
  OSSClause *RebuildOSSSharedClause(ArrayRef<Expr *> VarList,
                                    ...
                                    SourceLocation LParenLoc,
                                    SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsSharedClause(VarList, StartLoc, LParenLoc,
                                            EndLoc);
  }
  ...
  OSSClause *RebuildOSSPrivateClause(ArrayRef<Expr *> VarList,
                                     ...
                                     SourceLocation LParenLoc,
                                     SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsPrivateClause(VarList, StartLoc, LParenLoc,
                                             EndLoc);
  }
  ...
  OSSClause *RebuildOSSFirstprivateClause(ArrayRef<Expr *> VarList,
                                          ...
                                          SourceLocation LParenLoc,
                                          SourceLocation EndLoc) {
    return getSema().OmpSs().ActOnOmpSsFirstprivateClause(VarList, StartLoc, LParenLoc,
                                                  EndLoc);
  }
  ...
  /// By default, performs semantic analysis to build the new OpenMP clause.
  /// Subclasses may override this routine to provide different behavior.
  OMPClause *RebuildOMPLabelClause(Expr *A, SourceLocation StartLoc,
                                       SourceLocation LParenLoc,
                                       SourceLocation EndLoc) {
    return getSema().OpenMP().ActOnOpenMPLabelClause(A, StartLoc, LParenLoc, EndLoc);
  }
  ...
  ExprResult RebuildOSSArraySectionExpr(Expr *Base, SourceLocation LBracketLoc,
    ...
    return getSema().OmpSs().ActOnOSSArraySectionExpr(Base, LBracketLoc, LowerBound,
  ...
  ExprResult RebuildOSSArrayShapingExpr(Expr *Base, ArrayRef<Expr *> Shapes,
    ...
    return getSema().OmpSs().ActOnOSSArrayShapingExpr(Base, Shapes, LBLoc, RBLoc);
  }
  ...
  ExprResult RebuildOSSMultiDepExpr(Expr *DepExpr, ArrayRef<Expr *> MultiDepIterators,
    ...
    return getSema().OmpSs().ActOnOSSMultiDepExpression(
...
TreeTransform<Derived>::TransformForStmt(ForStmt *S) {
  ...
  if (getSema().getLangOpts().OmpSs && Init.isUsable())
    getSema().OmpSs().ActOnOmpSsLoopInitialization(S->getForLoc(), Init.get());
...
TreeTransform<Derived>::TransformOMPLabelClause(OMPLabelClause *C) {
  ...
  return getDerived().RebuildOMPLabelClause(
      Vars[0], C->getBeginLoc(), C->getLParenLoc(), C->getEndLoc());
}
...
TreeTransform<Derived>::TransformOSSTaskwaitDirective(OSSTaskwaitDirective *D) {
  getDerived().getSema().OmpSs().StartOmpSsDSABlock(OSSD_taskwait, nullptr,
                                            D->getBeginLoc());
  StmtResult Res = getDerived().TransformOSSExecutableDirective(D);
  getDerived().getSema().OmpSs().EndOmpSsDSABlock(Res.get());
  return Res;
}
...
TreeTransform<Derived>::TransformOSSReleaseDirective(OSSReleaseDirective *D) {
  getDerived().getSema().OmpSs().StartOmpSsDSABlock(OSSD_release, nullptr,
                                            D->getBeginLoc());
  StmtResult Res = getDerived().TransformOSSExecutableDirective(D);
  getDerived().getSema().OmpSs().EndOmpSsDSABlock(Res.get());
  return Res;
...
TreeTransform<Derived>::TransformOSSTaskDirective(OSSTaskDirective *D) {
  DeclarationNameInfo DirName;
  getDerived().getSema().OmpSs().StartOmpSsDSABlock(OSSD_task, nullptr,
                                            D->getBeginLoc());
  StmtResult Res = getDerived().TransformOSSExecutableDirective(D);
  getDerived().getSema().OmpSs().EndOmpSsDSABlock(Res.get());
  return Res;
...
TreeTransform<Derived>::TransformOSSCriticalDirective(OSSCriticalDirective *D) {
  getDerived().getSema().OmpSs().StartOmpSsDSABlock(
...
TreeTransform<Derived>::TransformOSSTaskForDirective(OSSTaskForDirective *D) {
  getDerived().getSema().OmpSs().StartOmpSsDSABlock(OSSD_task_for, nullptr,
                                             D->getBeginLoc());
  StmtResult Res = getDerived().TransformOSSExecutableDirective(D);
  getDerived().getSema().OmpSs().EndOmpSsDSABlock(Res.get());
  return Res;
...
TreeTransform<Derived>::TransformOSSTaskIterDirective(OSSTaskIterDirective *D) {
  getDerived().getSema().OmpSs().StartOmpSsDSABlock(OSSD_taskiter, nullptr,
                                             D->getBeginLoc());
  StmtResult Res = getDerived().TransformOSSExecutableDirective(D);
  getDerived().getSema().OmpSs().EndOmpSsDSABlock(Res.get());
  return Res;
...
TreeTransform<Derived>::TransformOSSTaskLoopDirective(OSSTaskLoopDirective *D) {
  DeclarationNameInfo DirName;
  getDerived().getSema().OmpSs().StartOmpSsDSABlock(OSSD_taskloop, nullptr,
                                             D->getBeginLoc());
  StmtResult Res = getDerived().TransformOSSExecutableDirective(D);
  getDerived().getSema().OmpSs().EndOmpSsDSABlock(Res.get());
  return Res;
...
TreeTransform<Derived>::TransformOSSTaskLoopForDirective(OSSTaskLoopForDirective *D) {
  getDerived().getSema().OmpSs().StartOmpSsDSABlock(OSSD_taskloop_for, nullptr,
                                             D->getBeginLoc());
  StmtResult Res = getDerived().TransformOSSExecutableDirective(D);
  getDerived().getSema().OmpSs().EndOmpSsDSABlock(Res.get());
  return Res;
...
TreeTransform<Derived>::TransformOSSAtomicDirective(OSSAtomicDirective *D) {
  DeclarationNameInfo DirName;
  getDerived().getSema().OmpSs().StartOmpSsDSABlock(OSSD_atomic, nullptr,
                                            D->getBeginLoc());
  StmtResult Res = getDerived().TransformOSSExecutableDirective(D);
  getDerived().getSema().OmpSs().EndOmpSsDSABlock(Res.get());
  return Res;
...
TreeTransform<Derived>::TransformOSSDependClause(OSSDependClause *C) {
  ...
  SemaOmpSs::AllowShapingsRAII AllowShapings(getSema().OmpSs(), []() { return true; });
